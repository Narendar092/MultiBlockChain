...
namespace XIDNA.Repository
{
    public interface IXiLinkRepository
    {
        ...
        //cBOInstance CreateFormData(VMSaveInlineEdit Savedata, string sDatabase, int FKiOrgID, int iUserID, string BOName);
        ...
        #region UploadFiles
        VMCustomResponse SaveFiles(int ID, string BOFieldID, int OrgID, List<HttpPostedFileBase> UploadImage, int iUserID, string sOrgName, string sDatabase, string sInstanceID);
