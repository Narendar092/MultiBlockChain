...
namespace XIDNA.Repository
{
    public class FieldsRepository : IFieldsRepository
    {
        ...
        //public DTResponse DisplayOrgMappedFields(jQueryDataTableParamModel param, string sDatabase, int FKiOrgID)
        //{
        ...
        public List<VMDropDown> GetOrgSubscriptions(int OrgID, string sDatabase, int iUserID, string sOrgName)
        {
            ...
            //var OrgClasses = Spdb.OrganizationSubscriptions.Where(m => m.OrganizationID == FKiOrgID).Where(m => m.StatusTypeID == 10).ToList();
        ...
        public string SaveMappedLeadFields(string Name, int ClsID, string DataField, string ColumnField, int OrgID, string sDatabase)
        {
            ...
            dbContext.SaveChanges();
            //var dbName = dbContext.AspNetUsers.Where(m => m.OrganizationID == FKiOrgID).Select(m => m.DatabaseName).FirstOrDefault();
        ...
        public List<VMDropDown> GetClassTypes(int OrgID, string sDatabase)
        {
            ...
            //var sClass = dbContext.OrganizationClasses.Where(m => m.OrganizationID == FKiOrgID).ToList();
