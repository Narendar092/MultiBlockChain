    ...
    public class WalletFileHandler
    {
        ...
        public CResult CreateUser(XIIBO oTransactiondetails)
        {
            ...
            try
            {
                ...
                oWParams.Add(new XIWhereParams { sField = "FKiOrgID", sOperator = "=", sValue = xifRole.FKiOrgID.ToString() });
                ...
                if (oUsers.Count() == 0)
                {
                    ...
                    oBOI.SetAttribute("FKiOrgID", xifRole.FKiOrgID.ToString());
                    oBOI.SetAttribute("FKiApplicationID", oQE.XIDataSource.FKiApplicationID.ToString());
                    iOrgID = xifRole.FKiOrgID ?? -1;
