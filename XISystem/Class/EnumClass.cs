namespace xiEnumSystem
{
    ...
    {
        KPICircle = 10, PieChart = 20, BarChart = 30, LineChart = 40, ResultList = 50, Summary = 60, Bespoke = 70, ViewRecord = 80, EmailReport = 90, CustomQuery = 100, Grid = 110, Repeater = 120, List = 130, Groupby = 150
    }
    ...
    {
        XI = 10, ActionChain = 20, XIAlgorithm = 30, Script = 40, QuestionSet = 50, DefaultPopup = 60, ConfirmationDialog=70, XILink=80, XILinkRun=90
    }
    ...
    {
        Process = 10, PCError = 20, PCSuccess = 30
    }
}
