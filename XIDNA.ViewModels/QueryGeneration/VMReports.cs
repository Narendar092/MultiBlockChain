...
namespace XIDNA.ViewModels
{
    public class VMReports
    {
        ...
        public List<VMHeaderNotification> headerNotifications { get; set; }
    ...
    public class VMUserNotification
    {
        public int ID { get; set; }
        public Guid XIGUID { get; set; }
        public int FKiNotificationID { get; set; }
        public int FKiTaskID { get; set; }
    ...
    public class VMHeaderNotification
    {
        public int ID { get; set; }
        public Guid XIGUID { get; set; }
        ...
        //public int iUserID { get; set; }
        public List<VMUserNotification> userNotifications { get; set; }
    }

    public class VMUserNotificationPreference
    {
        public int ID { get; set; }
        public Guid XIGUID { get; set; }
        public int iUserID { get; set; }
        public string sConstantID { get; set; }
        public bool bIsSubscribed { get; set; }
        public bool bShowToast { get; set; }
    ...
    {
        public List<VMReports> reports { get; set; }
        public List<VMHeaderNotification> headerNotifications { get; set; }
    }
}
