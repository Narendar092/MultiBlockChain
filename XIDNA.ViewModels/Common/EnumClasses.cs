...
namespace XIDNA.ViewModels
{
    ...
    {
        EditForm = 10, Sections = 20, Fields = 30, XIComponent = 40, Html = 50, Bespoke = 60, OneClick = 70, WhatsappTemplate = 100, WhatsappInteractiveTemplate = 120, WhatsappInteractiveImageTemplate = 130, WhatsappInteractiveMergeTemplate = 140, WhatsappInteractiveMergeImageTemplate = 150
    }
