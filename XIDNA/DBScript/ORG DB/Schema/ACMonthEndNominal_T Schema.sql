IF OBJECT_ID('ACMonthEndNominal_T', 'U') IS NOT NULL DROP TABLE dbo.ACMonthEndNominal_T

	
CREATE TABLE [ACMonthEndNominal_T]
(
	[id] INT NOT NULL,
	...
	[rCRCurrent] float NULL,
	[rDRCurrent] float NULL,
	[rCRPrevious] float NULL,
	[rDRPrevious] float NULL,
