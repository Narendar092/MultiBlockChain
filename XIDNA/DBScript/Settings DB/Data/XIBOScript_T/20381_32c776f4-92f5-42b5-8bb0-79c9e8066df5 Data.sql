INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20381',
 N'296',
 N'0',
 NULL,
 N'Star Legal simple cal Copy',
 N'PolicyCalculation',
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            try
            {
                ...
                oBII.Attributes["sName"] = new XIIAttribute { sName = "sName", sValue = "Star Legal", bDirty = true };
