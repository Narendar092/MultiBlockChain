INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20383',
 N'296',
 N'0',
 NULL,
 N'StarInsureOne_v1',
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        ...
        public class PolicyBaseCalc
        {
            ...
            public CResult GetVehicleMakeLoadFactor(string TypeOfMake)
            {
                ...
                try
                {
                    ...
                    else if (TypeOfMake == "volkswagen")
                    {
                        oNV1.sValue = "-10";
                    }
                    else if (TypeOfMake == "peugeot")
                    {
                        oNV1.sValue = "-5";
                    }
                    oresult.oCollectionResult.Add(oNV);
            ...
            public CResult GetAgeOfVechicleDiscount(int YearofManufacture, string dtInsuranceCoverStartDate)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                try
                {
                    ...
                    oNV3.sName = "Type";
                    oNV3.sValue = "Percent";
                    var CurrentDate = Convert.ToDateTime(dtInsuranceCoverStartDate).Year;
            ...
            public CResult GetOwnershipDiscount(int YearOfOwnerShip)
            {
                ...
                try
                {
                    ...
                    oNV3.sName = "Type";
                    oNV3.sValue = "Percent";
                    if (YearOfOwnerShip <= 5)
                    {
                        oNV1.sValue = "+15";
                    }
                    else if (YearOfOwnerShip > 5 && YearOfOwnerShip <= 11)
                    {
                        oNV1.sValue = "+10";
                    }
            ...
            public CResult GetMileageLoadFactor(int miles)
            {
                ...
                try
                {
                    ...
                    else if (miles >= 9001 && miles <= 12000)
                    {
                        oNV1.sValue = "+60";
                    }
                    else
            ...
            public CResult GetClaimLoadFactor(int NoOfClaims, List<XIIBO> ClaimI, string CoverStartDate, int iNoOfClaims)
            {
                ...
                try
                {
                    ...
                    DateTime dStartDate = Convert.ToDateTime(CoverStartDate);
                    foreach (var Claim in ClaimI)
                    {
                        ...
                        //}
                        var dt3Years = dStartDate.AddYears(-3).Date;
            ...
            public CResult GetAgeFromDOB(string dDOB, string PresentDate)
            {
                ...
                try
                {
                    oresult.sMessage = "dDOB_" + dDOB + " StartDate_" + PresentDate;

                    oIB.SaveErrortoDB(oresult);
                    DateTime dPolicyStartDate = Convert.ToDateTime(PresentDate);
                    int iAge = dPolicyStartDate.Year - Convert.ToDateTime(dDOB).Year;
                    if (dPolicyStartDate < Convert.ToDateTime(dDOB).AddYears(iAge)) iAge--;
            ...
            public CResult GetGaragingLoadFactor(string sWheredoyoustore, double rCaravanValue, string sPostCode, string sLocationOfMotorhomeOvernight, int iProductID)
            {
                ...
                try
                {
                    ...
                    if (sWheredoyoustore == "cassoa bronze site")
                    {
                        oNV1.sValue = "-2.5";
                    }
                    else if (sWheredoyoustore == "cassoa silver site")
                    {
                        oNV1.sValue = "-5";
                    }
                    else if (sWheredoyoustore == "cassoa gold site")
                    {
                        oNV1.sValue = "-10";
                    }
                    else if (!string.IsNullOrEmpty(sLocationOfMotorhomeOvernight) && (sLocationOfMotorhomeOvernight.ToLower() == "more than 100 metres of home address" || sLocationOfMotorhomeOvernight.ToLower() == "within 100 metres of home address"))
                    {
                        oNV.sValue = xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString();
                    }
                    else if (sWheredoyoustore == "garaged" && sLocationOfMotorhomeOvernight.ToLower() == "home address")
                    {
                        oNV1.sValue = "-7.5";
                    }
                    else if (sWheredoyoustore == "locked compound" && sLocationOfMotorhomeOvernight.ToLower() == "home address")
                    {
                        oNV1.sValue = "-2.5";
                    }
                    else
            ...
            public CResult GetMinimumPremium(int YearofManufacture, string dtInsuranceCoverStartDate)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                try
        ...
        {
            public CResult Calculation(int iInstanceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sProductCode, string sSessionID, string sUID, int iQuoteID)
            {
                ...
                try
                {
                    ...
                    foreach (var item in oDriversI)
                    {
                        ...
                        //oIB.SaveErrortoDB(oResult);
                        Info.Add("DriverID_" + item.Attributes["id"].sValue + "_QSInstanceID_" + iInstanceID);
                        ...
                        if (oCresult.bOK && oCresult.oResult != null)
                        {
                            ...
                            string sParams = "";
                            foreach (var Parm in oSQLParams)
                            {
                                Info.Add("HMSanction sqlparam : " + Parm.ParameterName + "_" + Parm.Value);
                                sParams += Parm.ParameterName + ":" + Parm.Value + " ";
                            }

                            Info.Add("HMSanction Query_" + sSql + " _Params : " + sParams);
                        ...
                        //}
                        result = PolicyCal.GetAgeFromDOB(DOB, dtInsuranceCoverStartDate);
                        if (result.xiStatus == 00 && result.oResult != null)
                        {
                        ...
                        oIB.SaveErrortoDB(oResult);
                        var ores = PolicyCal.GetAgeFromDOB(dPassed, dtInsuranceCoverStartDate);
                        ...
                        else
                        {
                            ...
                            if (int.TryParse(UKResidentYear, out iUKResidentYear))
                            {
                                ...
                                DateTime CoverStartDate = Convert.ToDateTime(dtInsuranceCoverStartDate);
                                dUkResyr = (CoverStartDate.Year - iUKResidentYear);
                                if (CoverStartDate.Month < iUKResidentMonth) dUkResyr--;
                    ...
                    { }
                    var oVehicleAgeLoad = PolicyCal.GetAgeOfVechicleDiscount(iYearOfManufacture, dtInsuranceCoverStartDate);
                    ...
                    var oDateOfPurchase = PolicyCal.GetAgeFromDOB(sDateofpurchase, dtInsuranceCoverStartDate);
                    if (oDateOfPurchase.xiStatus == 00 && oDateOfPurchase.oResult != null)
                    {
                        ...
                        DateTime dStartDate = Convert.ToDateTime(dtInsuranceCoverStartDate);
                        iYearOfOwnershipInMonths = 12 * (dStartDate.Year - dDAte.Year) + dStartDate.Month - dDAte.Month;
                        if ((dStartDate < Convert.ToDateTime(sDateofpurchase).AddMonths(iYearOfOwnershipInMonths))) iYearOfOwnershipInMonths--;
                    }
                    ...
                    var MinimumPremium = PolicyCal.GetMinimumPremium(iYearOfManufacture, dtInsuranceCoverStartDate);
                    ...
                    oBII.Attributes["FKiQSInstanceID"] = new XIIAttribute { sName = "FKiQSInstanceID", sValue = iInstanceID.ToString(), bDirty = true };
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "StarInsureOne", bDirty = true };
