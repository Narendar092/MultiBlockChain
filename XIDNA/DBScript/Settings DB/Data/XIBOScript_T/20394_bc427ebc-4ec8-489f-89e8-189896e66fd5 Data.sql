INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20394',
 N'296',
 N'0',
 NULL,
 N'RoyalInsurer_v1 Copy',
 N'PolicyCalculation',
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(int iInstanceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sProductCode, string sVersion, string sSessionID, string sUID, int iQuoteID)
            {
                ...
                try
                {
                    ...
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "RoyalInsurer", bDirty = true };
