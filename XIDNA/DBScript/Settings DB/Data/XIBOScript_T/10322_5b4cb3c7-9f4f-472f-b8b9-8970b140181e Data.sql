INSERT INTO [XIBOScript_T] ([ID],
        ...
        public class ConvertRenewal
        {
            ...
            public CResult SendRequest(string sGUID, int iInstanceID, int iUserID, int iProductID)
            {
                ...
                try
                {
                    ...
                    string ConvertQuoteResponse = "select id,sProduceRenewalResponse from APIQuotes_T where FKQSInstanceID=" + iInstanceID.ToString() + " order by id desc";
                    ...
                    if (QueryResult.Rows.Count > 0)
                    {
                        ...
                        PolicyRef = doc1.Descendants(XNamespace.Get(ns.ToString()) + "Reference").First().Value.ToString();
                    }
                    var oProduceRenewal = (List<XIContentEditors>)oCache.GetObjectFromCache(XIConstant.CacheTemplate, "Convert Renewal", "0");
                    ...
                    if (oProduceRenewalC != null)
                    {
                        ...
                        sTypeofCover = sTypeofCover.Replace("{Reference}", PolicyRef);
                        ...
                        string url = APIValues.Where(x => x.AttributeI("sName").sValue.ToLower() == "ConvertRenewalURL".ToLower()).Select(t => t.AttributeI("sValue").sValue).FirstOrDefault();
                        HttpWebRequest rqst = (HttpWebRequest)HttpWebRequest.Create(url);
                        rqst.Timeout = -1;
                        rqst = BuildWebRequest(APIValues, APIKey, APIPWD, "ConvertRenewal", sGUID);
                        ...
                        oboi.SetAttribute("sConvertRenewalRequest", sTypeofCover);
                        oboi.SetAttribute("sConvertRenewalResponse", oProduceRenewalC.Content);
 ...
 NULL,
 NULL,
 N'5b4cb3c7-9f4f-472f-b8b9-8970b140181e',
 N'0',
 N'0',
 N'0',
