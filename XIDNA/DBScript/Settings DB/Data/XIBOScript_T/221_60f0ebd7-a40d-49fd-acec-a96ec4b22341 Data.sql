INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'0',
 NULL,
 N'MarkerStudyTest_Backup_02-08-19',
 N'PolicyCalculation',
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
                ...
                try
                {
                    ...
                    foreach (var Claim in ClaimI)
                    {
                        ...
                        if (dtClaimDate >= dt3Years)
                        {
                            ...
                            if (sClaimName == "vandalism" || sClaimName == "malicious damage (theft)" || sClaimName == "theft"  || sClaimName == "fire")
                            {
                                dPoints = 20;
                            }
           ...
           public CResult GetConvictionsDemeritPoints(int NoOfConvictions, List<XIIBO> ConvictionI, string PolicyStartDate)
            {
                ...
                try
                {
                    ...
                    foreach (var Conviction in ConvictionI)
                    {
                        ...
                        if (BanDays > 28 && BanDays < 180 && dDAte >= sPolicyStartDAte.AddYears(-3) && dDAte <= sPolicyStartDAte)
                        {
                            sDemeritpoints = "20";
                        }
        ...
        ClaimConvictionResult = PolicyCal.DemeritPoints(iDemeritPoints, "Claim/Conviction Demerit Points LoadFactor");
                   ...
                   // }
                    ...
                    if (!string.IsNullOrEmpty(sVehicleKeeper) && (sVehicleKeeper.ToLower() == "partner - civil" || sVehicleKeeper.ToLower() == "other family member"))
                    {
