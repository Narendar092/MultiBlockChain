INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        ...
        public class PolicyBaseCalc
        {
            ...
            public CResult GetDriverAgeLoad(int iAge)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        var oAgeLoad = oXIAPI.GetValue("ZenithAgeLoad_T", "rLoad", oWHParams);
                        if (!string.IsNullOrEmpty(oAgeLoad))
                        {
                            oNV1.sValue = oAgeLoad;
                        }
                    }
                    oresult.oCollectionResult.Add(oNV);
                    oresult.oCollectionResult.Add(oNV1);
            ...
            public CResult GetGaragingLoad(string Area, string sTypeOfCover, string sGaraging)
            {
                ...
                try
                {
                    ...
                    if ((sGaraging == "Garage" || sGaraging == "Locked Building" || sGaraging == "Locked Compound") && (sTypeOfCover == "Comp" || sTypeOfCover == "TPFT"))
                    {
                    ...
                    else if ((sGaraging == "Garage" || sGaraging == "Locked Building" || sGaraging == "Locked Compound") && sTypeOfCover == "TPO")
                    {
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sProductCode, string sSessionID, string sUID, int iQuoteID)
            {
                ...
                try
                {
                    ...
                    List<CResult> DriverAgeLoadResult = new List<CResult>();
                    ...
                    foreach (var item in oDriversI)
                    {
                        ...
                        if (result.xiStatus == 00 && result.oResult != null)
                        {
                            ...
                            var oAgeLoad = PolicyCal.GetDriverAgeLoad(Age);
                            if (oAgeLoad.xiStatus == 0 && oAgeLoad.oCollectionResult.Count > 0)
                            {
                                DriverAgeLoadResult.Add(oAgeLoad);
                            }
                    ...
                    //Driver Age
                    var oDriverAgeLoad = PolicyCal.GetMaxLoadFactor(DriverAgeLoadResult);
                    if (oDriverAgeLoad.bOK && oDriverAgeLoad.oCollectionResult.Count > 0)
                    {
                        oXiResults.Add(oDriverAgeLoad);
                    }
                    ...
                    if (oMedicalConditionLoad != null && oMedicalConditionLoad.oCollectionResult.Count > 0 && oMedicalConditionLoad.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString())
                    {
                        oXiResults.Add(oMedicalConditionLoad);
                    }
                    if (oEmploymentType != null && oEmploymentType.oCollectionResult.Count > 0 && oEmploymentType.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString())
                    {
