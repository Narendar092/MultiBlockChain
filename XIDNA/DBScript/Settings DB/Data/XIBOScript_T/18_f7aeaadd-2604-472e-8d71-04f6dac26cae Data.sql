INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "ZENITH script running";
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sSessionID, string sUID)
            {
                ...
                try
                {
                    ...
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "ZENITH", bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "ZENITH Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
                    XIIBO oBO = new XIIBO();
 ...
 N'C# Code',
 N'0',
 N'2018-08-17 15:14:38.000',
 N'6',
 N'fe80::ad6c:bdf0:2de6:369d%3',
 N'6',
 N'192.168.7.6',
 N'2018-12-15 12:33:40.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
