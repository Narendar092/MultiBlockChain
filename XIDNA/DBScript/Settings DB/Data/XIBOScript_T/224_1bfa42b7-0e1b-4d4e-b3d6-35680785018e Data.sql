INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'0',
 NULL,
 N'MarkerStudyTest_Backup_12-08-19',
 N'PolicyCalculation',
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
           ...
           public CResult GetConvictionsDemeritPoints(int NoOfConvictions, List<XIIBO> ConvictionI, string PolicyStartDate)
            {
                ...
                try
                {
                    ...
                    foreach (var Conviction in ConvictionI)
                    {
                        ...
                        if (BanDays > 180 && dDAte >= sPolicyStartDAte.AddYears(-5) && dDAte <= sPolicyStartDAte)
                        {
                            sDemeritpoints = "20";
                        }
            ...
            public CResult GetGaragingLoadFactor(string sWheredoyoustore, double rCaravanValue, string sPostCode,string sLocationOfMotorhomeOvernight)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                try
        ...
        ClaimConvictionResult = PolicyCal.DemeritPoints(iDemeritPoints, "Claim/Conviction Demerit Points LoadFactor");
                   ...
                   // }
                    ...
                    //Garaging
                    var oGaraging = PolicyCal.GetGaragingLoadFactor(sGaraging, rCaravanVal, sPostCode,sLocationOfMotorhomeOvernight);
