INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'102',
 N'296',
 N'0',
 NULL,
 N'TestPolicyCalculation',
 N'PolicyCalculation',
            ...
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sSessionID, string sUID)
            {
                ...
                try
                {
                    ...
                    if (oXiResults.All(m => m.oCollectionResult.Where(x => x.sName == "sMessage").All(x => x.sValue == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())) && oExcessVal.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && oBaseLoadFactor.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && LeftHandLoadFactor.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())
                    {
                        ...
                        var miniumDeposit = oProductI.Attributes["zDefaultDeposit"].sValue;
                        double MinimumDepositPercentage = 0;
                        double MinimumDepositAmount = 0;
                        if(double.TryParse(miniumDeposit, out MinimumDepositPercentage))
                        {
 ...
 N'C# Code',
 N'0',
 N'2019-01-03 17:57:19.000',
 N'6',
 N'192.168.7.6',
 N'6',
 N'192.168.7.6',
 N'2019-01-09 18:21:56.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
