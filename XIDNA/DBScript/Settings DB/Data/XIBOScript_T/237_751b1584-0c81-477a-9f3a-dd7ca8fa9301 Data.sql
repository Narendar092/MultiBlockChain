INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'237',
 N'296',
 N'0',
 NULL,
 N'KGMCalculation_September2019_new',
 N'PolicyCalculation',
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        ...
        public abstract class PolicyBaseCalc
        {
            ...
            //        oNV2.sValue = "On Road Load";
            //        var Area = "";
            //        if (!string.IsNullOrEmpty(sGaraging) && (sGaraging.ToLower() == "Kept on Third Party Premises".ToLower() || sGaraging.ToLower() == "car park" || sGaraging.ToLower() == "unlocked compound" || sGaraging.ToLower() == "locked compound" || sGaraging.ToLower() == "wooden shed" || sGaraging.ToLower() == "shed"))
            //        {
            //            oNV.sValue = xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString();
            //        }
            //        else if (rExcessVal >= 20000)
            //        {
            //            if (!string.IsNullOrEmpty(sGaraging) && sGaraging.ToLower() == "kept on private property" && !string.IsNullOrEmpty(sLocationOfMotorhomeOvernight) && sLocationOfMotorhomeOvernight.ToLower() != "home address")
            //            {
            //                oNV.sValue = xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString();
            //            }
            //        }
            ...
            //                //    }
            //                //}
            //                if (!string.IsNullOrEmpty(sLocationOfMotorhomeOvernight) && (sLocationOfMotorhomeOvernight.ToLower() == "home address" || sLocationOfMotorhomeOvernight.ToLower() == "within 100 metres of home address"))
            //                {
            //                    oNV1.sValue = "+30";
            //                }
            //            }
            ...
            public CResult GetExcessValue(double iCurrentCaravanValue, string sTypeOfCover, string sTypeofDevice)
            {
                ...
                try
                {
                    ...
                    int f1 = 0, f2 = 0;
                    double ExcessValue;
                    oresult.sMessage = "Type Of Device:" + sTypeofDevice;
                    oIB.SaveErrortoDB(oresult);
