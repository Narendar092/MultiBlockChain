INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "HDFC script running";
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion,string sSessionID,string sUID)
            {
                ...
                try
                {
                    ...
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "HDFC", bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "HDFC Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
                    XIIBO oBO = new XIIBO();
                    ...
                    oResult.oCollectionResult.Add(new CNV { sName = "QuoteID", sValue = oBII.Attributes["ID"].sValue });
                       oResult.sMessage = "QuoteID_ID :"+oBII.Attributes["ID"].sValue;
                        oIB.SaveErrortoDB(oResult);
                        oResult.sMessage = "QuoteID_id :"+oBII.Attributes["id"].sValue;
                        oIB.SaveErrortoDB(oResult);
 ...
 N'C# Code',
 N'0',
 N'2018-12-12 16:30:01.000',
 N'6',
 N'192.168.7.6',
 N'6',
 N'192.168.7.6',
 N'2018-12-15 12:35:32.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
