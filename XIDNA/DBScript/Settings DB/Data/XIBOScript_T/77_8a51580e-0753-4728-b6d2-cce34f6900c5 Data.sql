INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "branding policy 1 script running";
            ...
            try
            {
                ...
                oIB.SaveErrortoDB(oResult);
                oResult = Pcal.Calculation(oQsInstance, iUserID, iCustomerID, sDataBase, sProductName, sVersion);
                oNV.sValue = "00";
            }
            catch (Exception ex)
            {
        ...
        {
            public CResult Calculation(XIIQS QSInstance, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oResult = new CResult();
                try
                {
                    ...
                    var iBatchID = iCustomerID.ToString() + QSInstance.ID.ToString();
                    oBII.Attributes["FKiQSInstanceID"] = new XIIAttribute { sName = "FKiQSInstanceID", sValue = QSInstance.ID.ToString(), bDirty = true };
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "Payment Bazar 1", bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "Payment Bazar 1 Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
                    XIIBO oBO = new XIIBO();
 ...
 N'C# Code',
 N'0',
 N'2018-12-14 10:46:39.000',
 N'0',
 N'192.168.7.6',
 N'6',
 N'192.168.7.6',
 N'2018-12-14 10:47:27.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
 ...
 NULL,
 NULL,
 N'8a51580e-0753-4728-b6d2-cce34f6900c5',
 N'0',
 N'0',
 N'0',
