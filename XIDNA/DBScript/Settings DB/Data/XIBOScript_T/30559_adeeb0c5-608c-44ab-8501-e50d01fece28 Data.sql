Delete XIBOScript_T where XIGUID='adeeb0c5-608c-44ab-8501-e50d01fece28'
INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'30559',
 N'296',
 N'0',
 NULL,
...
public class PolicyCalculation
{
    public CResult Calculation(string iInsatnceID, int iUserID, int iCustomerID, string sVersion, string sProductCode, int iQuoteID, int iOrgID, int ProductID)
    {
        ...
        Info.Add("Sterling Insurance script running");
        XIInstanceBase oIB = new XIInstanceBase();
        CResult oresult = new CResult();
        ...
        try
        {
            ...
            if (ostructureInstance.XIIValues.Count() > 0)
            {
				...
				if (ostructureInstance.XIIValues.ContainsKey("sCanyouconfirmwhoistheregisteredkeeper"))
                {
                    ...
                    if (registeredkeeper == "Proposer" || registeredkeeper == "Spouse")
                    {
                ...
                if (ostructureInstance.XIIValues.ContainsKey("Campaign Number for L2M use only"))
                {
                    ...
                    if (L2Museonly >= 00 && L2Museonly <= 1938)
                    {
                        l2muse = true;
                    }
                    else
            ...
            if (ages && UKlicences && startdt && Valueofyourvehicles && postcode && registeredkeepers)
            {
