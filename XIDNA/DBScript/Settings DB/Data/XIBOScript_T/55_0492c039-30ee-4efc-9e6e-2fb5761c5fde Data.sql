INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'0',
 NULL,
 N'MoneySuperMarket Copy Copy Copy',
 N'MoneySuperMarket',
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "MoneySuperMarket script running";
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(XIIQS QSInstance, int iUserID, int iCustomerID, string sDataBase, string sProductName, string ProductID, string sVersion)
            {
                ...
                try
                {
                    ...
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "MoneySuperMarket", bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "MoneySuperMarket Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
                    XIIBO oBO = new XIIBO();
 ...
 NULL,
 NULL,
 N'0492c039-30ee-4efc-9e6e-2fb5761c5fde',
 N'0',
 N'0',
 N'0',
