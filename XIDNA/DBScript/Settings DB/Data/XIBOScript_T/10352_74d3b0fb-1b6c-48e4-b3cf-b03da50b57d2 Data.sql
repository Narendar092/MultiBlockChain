INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'0',
 NULL,
 N'SCTowerGate Calculation Copy',
 N'PolicyCalculation',
        ...
        public class SCTowergate
        {
            ...
            public CResult GetOccupationsLoadFactor(string sOccupation, string sSecOccupation)
            {
                ...
                try
                {
                    ...
                    string[] DeclineArray = new string[] { "acrobat", "actor or actress", "amusement arcade worker", "antique dealer", "antique renovator", "art buyer", "art dealer", "asphalter", "bodyguard", "bricklayer", "broadcaster", "circus proprietor", "circus worker", "coin dealer", "croupier", "dancer", "dealer - general", "diamond dealer", "disc jockey", "entertainer", "exotic dancer", "fairground worker", "floor manager", "footballer - semi professional", "furniture dealer", "furniture restorer", "gambler", "gaming club manager", "gaming club proprietor", "golf caddy", "golf club professional", "golf coach", "golfer", "hawker", "horse breeder", "horse dealer (non sport)", "horse dealer (sport)", "horse trader", "horse trainer", "interviewer", "jeweller", "jockey", "journalist", "journalist - freelance", "journalistic agent", "kissagram person", "landscape gardener", "landworker", "licensee", "magician", "manager - sports", "market trader", "medal dealer", "model", "money broker", "money dealer", "moneylender", "motor dealer", "motor racing driver", "motor racing organiser", "motor trader", "music producer", "musician", "musician - amateur", "classical musician", "non professional sports coach", "opera singer", "orchestra leader", "orchestral violinist", "playwright", "private detective", "private investigator", "professional apprentice footballer", "professional boxer", "professional cricketer", "professional cyclist", "professional footballer", "professional sports coach", "professional wrestler", "promoter", "promoter - entertainments", "promoter - racing", "promoter - ring sports", "promoter - sports", "publican", "publicity manager", "publisher", "publishing manager", "racehorse groom", "racing motorcyclist", "racing organiser", "radio director", "radio presenter", "radio producer", "rally driver", "scrap dealer", "second hand dealer", "show jumper", "showman or woman", "snooker player", "song writer", "sports administrator", "sports agent", "sports centre attendant", "sports coach", "sports commentator", "sports scout", "sportsman or woman", "store detective", "street entertainer", "street trader", "student - living away", "stunt - living at home", "student nurse - living at home", "student nurse - living away", "student teacher - living at home", "student teacher - living away", "tv announcer", "tv broadcasting technician", "tv editor", "tarot reader/palmistry expert", "television director", "television presenter", "television producer", "turf accountant", "undergraduate student - living at home", "undergraduate student - living away from home", "unemployed", "ventriloquist", "waste dealer", "bookmaker", "broadcaster - tv/radio", "dealer", "dealer - scrap/waste", "footballer", "gaming club staff - licensed premises", "gaming club staff - unlicensed premises", "horse dealer", "manager - ring sports", "musician - dance band", "musician - pop group", "night club staff", "non professional footballer", "professional racing driver", "professional racing motorcyclist", "professional sportsperson", "semi-professional sportsperson", "sports administrator - other sports", "sports administrator - ring sports", "student", "student - foreign", "student - living at home", "student nurse", "student teacher", "trainer - animal", "trainer - greyhound", "trainer - race horse", "travelling showman" };
                    ...
                    //string[] DeclineArray = new string[] { "acrobat", "actor(combined)", "actor or actress", "actress(combined)", "amusement arcade worker", "antique dealer", "antique renovator", "art buyer", "art dealer", "asphalter", "bodyguard", "bricklayer", "broadcaster", "circus proprietor", "circus worker", "coin dealer", "croupier", "dancer", "dealer - general", "diamond dealer", "disc jockey", "entertainer", "exotic dancer", "fairground worker", "floor manager", "footballer - semi professional", "furniture dealer", "furniture restorer", "gambler", "gaming club manager", "gaming club proprietor", "golf caddy", "golf club professional", "golf coach", "golfer", "hawker", "horse breeder", "horse dealer (non sport)", "horse dealer (sport)", "horse trader", "horse trainer", "interviewer", "jeweller", "jockey", "journalist", "journalist - freelance", "journalistic agent", "kissagram person", "landscape gardener", "landworker", "licensee", "magician", "manager - sports", "market trader", "medal dealer", "model", "money broker", "money dealer", "moneylender", "motor dealer", "motor racing driver", "motor racing organiser", "motor trader", "music producer", "musician", "musician - amateur", "classical musician", "non professional sports coach", "opera singer", "orchestra leader", "orchestral violinist", "playwright", "private detective", "private investigator", "professional apprentice footballer", "professional boxer", "professional cricketer", "professional cyclist", "professional footballer", "professional sports coach", "professional wrestler", "promoter", "promoter - entertainments", "promoter - racing", "promoter - ring sports", "promoter - sports", "publican", "publicity manager", "publisher", "publishing manager", "racehorse groom", "racing motorcyclist", "racing organiser", "radio director", "radio presenter", "radio producer", "rally driver", "scrap dealer", "second hand dealer", "show jumper", "showman or woman", "snooker player", "song writer", "sports administrator", "sports agent", "sports centre attendant", "sports coach", "sports commentator", "sports scout", "sportsman or woman", "store detective", "street entertainer", "street trader", "student - living away", "stunt - living at home", "student nurse - living at home", "student nurse - living away", "student teacher - living at home", "student teacher - living away", "tv announcer", "tv broadcasting technician", "tv editor", "tarot reader/palmistry expert", "television director", "television presenter", "television producer", "turf accountant", "undergraduate student - living at home", "undergraduate student - living away from home", "unemployed", "ventriloquist", "waste dealer" };
            ...
            public CResult GetCaravanFinalPremium(string sGUID, int iInstanceID, int iUserID, string sProductName, string sVersion, string sSessionID, int iCustomerID, int iQuoteID)
            {
                ...
                try
                {
                    ...
                    string sOccupation = ostructureInstance.XIIValue("OccupationSC").sResolvedValue;
                    string sSecondaryOccupation = ostructureInstance.XIIValue("SecondaryOccupationSC").sResolvedValue;
                    ...
                    {
                        oXiResults.Add(BuildCResultObject("0.0", "Refused or canceled insurance", xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString()));
                    }
                    if (!string.IsNullOrEmpty(sbankruptcy) && sbankruptcy.ToLower() == "yes")
                    {
                        oXiResults.Add(BuildCResultObject("0.0", "Bankruptcy", xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString()));
                    }
                    if (!string.IsNullOrEmpty(ssMotorOffence) && ssMotorOffence.ToLower() == "yes")
                    {
                        oXiResults.Add(BuildCResultObject("0.0", "Non-motoring offence", xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString()));
                    }
                    if (!string.IsNullOrEmpty(sfeltroof) && sfeltroof.ToLower() == "no")
                    {
                        ...
                        {
                            oXiResults.Add(BuildCResultObject(sfeltroof, "If felt roof has not been replaced in last 10 years", xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString()));
                        }
                    }
