INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "MTA Livhome script running";
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(int iInsatnceID, string dCoverStart, string rGrossPremium, string QuoteID)
            {
                ...
                try
                {
                    ...
                    oResult.sMessage = "Livhome QuotePrice" + QuotePrice;
                    oIB.SaveErrortoDB(oResult);
                    if (double.TryParse(QuotePrice, out total))
                    { }
                    oResult.sMessage = "Livhome Quote total" + total;
                    oIB.SaveErrortoDB(oResult);
                    if (total > 0)
                    {
                    ...
                    oResult.sMessage = "Livhome MTA Cost " + total;
                    oIB.SaveErrortoDB(oResult);
                    if (total >= -25 && total <=0)
                    {
                        total = 0.0;
                ...
                oBII.Attributes["rPrice"] = new XIIAttribute { sName = "rPrice", sValue = total.ToString(), bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "Livhome Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
 ...
 N'C# Code',
 N'0',
 N'2018-12-18 15:07:17.000',
 N'6',
 N'fe80::1584:fa50:8b91:a35d%9',
 N'6',
 N'fe80::1584:fa50:8b91:a35d%9',
 N'2018-12-18 15:08:55.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
