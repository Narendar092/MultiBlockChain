INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'0',
 NULL,
 N'TowerGateCalculation New Copy',
 N'PolicyCalculation',
 N'public static CResult CaravanCalculation(List<CNV> lParam)
        ...
        public class TouringCaravan
        {
            ...
            public static double rAdditionalLoad = 0;
            ...
            public CResult GetTCCMDiscount(List<CNV> oParams)
            {
                ...
                try
                {
                    ...
                    //var sAdditionalLoad = oParams.Where(x => x.sName == "rAdditionalLoad").Select(x => x.sValue).FirstOrDefault();
                    ...
                    //if(double.TryParse(sAdditionalLoad,out rAdditionalLoad)){
                    //}
                    oGeneralRefers.Add(BuildCResultObject(rAdditionalLoad.ToString(), "Additional Load", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    rAppliedPremiumDiscountLoad += (rAppliedPremiumDiscountLoad * 0.01) * rAdditionalLoad;
                ...
                try
                {
                    ...
                    foreach (var item in oDriversI)
                    {
                        ...
                        if (!string.IsNullOrEmpty(sIsMainDrive) && sIsMainDrive.ToLower() == "true")
                        {
                            ...
                            if (iProposerAge < 25)
                            {
                                oGeneralRefers.Add(BuildCResultObject(iProposerAge.ToString(), "Proposer Age", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                            }
                            else
                            {
                                oGeneralRefers.Add(BuildCResultObject(iProposerAge.ToString(), "Proposer Age", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                            }
                        }
                    ...
                    string sCaravanMake = ostructureInstance.XIIValue("CaravanMakeTC").sResolvedValue;
                    if (!string.IsNullOrEmpty(sCaravanMake) && sCaravanMake.TrimEnd().ToLower() == "other")
                    {
                        oGeneralRefers.Add(BuildCResultObject(sCaravanMake, "Caravan Make", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sCaravanMake, "Caravan Make", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    ...
                    if (ContentsSI > 3000)
                    {
                        oGeneralRefers.Add(BuildCResultObject(sContentsSI, "Contents Value", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sContentsSI, "Contents Value", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    //}
                    ...
                    if (!string.IsNullOrEmpty(sEquipmentInsured) && sEquipmentInsured.ToLower() == "yes")
                    {
                        ...
                        if (EquipmentSI > 3000)
                        {
                            oGeneralRefers.Add(BuildCResultObject(sEquipmentSI, "Equipment Value", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                        }
                        else
                        {
                            oGeneralRefers.Add(BuildCResultObject(sEquipmentSI, "Equipment Value", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(sAwningInsured) && sAwningInsured.ToLower() == "yes")
                    {
                        ...
                        if (AwningSI > 3000)
                        {
                            oGeneralRefers.Add(BuildCResultObject(sAwningSI, "Awning Value", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                        }
                        else
                        {
                            oGeneralRefers.Add(BuildCResultObject(sAwningSI, "Awning Value", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                        }
                    }
                    ...
                    if (CaravanSI > 65000)
                    {
                        oGeneralRefers.Add(BuildCResultObject(sCaravanSI, "Caravan Value", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sCaravanSI, "Caravan Value", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    ...
                    {
                        oGeneralRefers.Add(BuildCResultObject(sIsInGoodState, "Good State of Repair", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sIsInGoodState, "Good State of Repair", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    ...
                    if (!string.IsNullOrEmpty(sNoneTCSecurity) && sNoneTCSecurity.ToLower() == "true")
                    {
                        oGeneralRefers.Add(BuildCResultObject(sNoneTCSecurity, "security", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    ...
                    if (string.IsNullOrEmpty(sWheelsRemoveSecurity) || sWheelsRemoveSecurity == "false")
                    {
                        if (string.IsNullOrEmpty(sWheelClampSecurity) || sWheelClampSecurity == "false")
                        {
                            if (string.IsNullOrEmpty(sChassisSecureWheelLockTC) || sChassisSecureWheelLockTC == "false")
                            {
                                ...
                                {
                                    oGeneralRefers.Add(BuildCResultObject(sWheelsRemoveSecurity, "Security", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                                }
                                //else
                                //{
                    ...
                    {
                        if (!string.IsNullOrEmpty(sTypeofCaravan) && sTypeofCaravan.ToLower() == "fifth wheeler".ToLower())
                        {
                            oGeneralRefers.Add(BuildCResultObject(sMonitoredTrackerTCSecurity, "Monitored Tracker", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                        }
                    }
                    ...
                    if (string.IsNullOrEmpty(sLockingPinTCSecurity) || sLockingPinTCSecurity == "false")
                    {
                        if (!string.IsNullOrEmpty(sTypeofCaravan) && sTypeofCaravan.ToLower() == "fifth wheeler".ToLower())
                        {
                            oGeneralRefers.Add(BuildCResultObject(sLockingPinTCSecurity, "Locking Pin", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                        }
                    }
                    string[] oStorageTypeReferArray = new string[] { "Business premises in the UK", "Working farm in the UK", "Non working farm in the UK", "Other" };
                    int iPos = Array.IndexOf(oStorageTypeReferArray, sCaravanLocation);
                    if (iPos > -1)
                    {
                        oGeneralRefers.Add(BuildCResultObject(sCaravanLocation, "Caravan Location", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sCaravanLocation, "Caravan Location", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    if (oSecurityVanList != null && oSecurityVanList.Count() > 0)
                    {
                        iSecurityVan = oSecurityVanList.Where(x => x.ToLower() == "true").Count();
                    }
                    ...
                    {
                        if (!string.IsNullOrEmpty(sCaravanLocation) && (sCaravanLocation.ToLower() != "other residential address" || sCaravanLocation.ToLower() != "home address"))
                        {
                            oGeneralRefers.Add(BuildCResultObject(sLockableGatesTC1, "Lockable Gates", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                        }
                        else
                        {
                            oGeneralRefers.Add(BuildCResultObject(sLockableGatesTC1, "Lockable Gates", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                        }
                    }
                    string sStorageLocation = ostructureInstance.XIIValue("None2TC").sValue;
                    if (!string.IsNullOrEmpty(sStorageLocation) && sStorageLocation.ToLower() == "true")
                    {
                        oGeneralRefers.Add(BuildCResultObject(sStorageLocation, "Storage Location", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sStorageLocation, "Storage Location", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    string sStorageLocationCaravansCount = ostructureInstance.XIIValue("caravansstoredlocationTC1").sResolvedValue;
                    string sSecondaryStorageLocationCaravans = ostructureInstance.XIIValue("secondarystoragelocationTC").sResolvedValue;
                    if (!string.IsNullOrEmpty(sSecondaryStorageLocationCaravans) && (sSecondaryStorageLocationCaravans.ToLower() != "other residential address" || sSecondaryStorageLocationCaravans.ToLower() != "home address") && !string.IsNullOrEmpty(sStorageLocationCaravansCount) && sStorageLocationCaravansCount.ToLower() == "less than 10")
                    {
                        oGeneralRefers.Add(BuildCResultObject(sStorageLocationCaravansCount, "Caravan Count", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    else
                    {
                        oGeneralRefers.Add(BuildCResultObject(sStorageLocationCaravansCount, "Caravan Count", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                    }
                    ...
                    {
                        iSecurityStorage = oSecurityStorageList.Where(x => x.ToLower() == "true").Count();
                    }
                    //if (int.TryParse(sSecurityvan, out iSecurityvan)) { }
                    //if (int.TryParse(sSecurityStorage, out iSecurityStorage)) { }
                    var sSecurity = iSecurityVan + iSecurityStorage;
                    ...
                    if (iProposerAge < 25)
                    {
                        oGeneralRefers.Add(BuildCResultObject(iProposerAge.ToString(), "Age", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    ...
                    string sGeographicalLimit = ostructureInstance.XIIValue("towyourcaravanineuropeTC").sResolvedValue.ToLower() == "yes" ? "Europe" : "UK";
                    oParams.Add(new CNV { sName = "sGeographicalLimit", sValue = sGeographicalLimit });
                    ...
                    //oParams.Add(new CNV { sName = "rAdditionalLoad", sValue = rAdditionalLoad.ToString() });
