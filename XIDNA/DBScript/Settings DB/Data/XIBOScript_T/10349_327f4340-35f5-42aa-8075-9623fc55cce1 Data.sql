        ...
        public class PHTowergate
        {
            ...
            public CResult GetCaravanFinalPremium(string sGUID, int iInstanceID, int iUserID, string sProductName, string sVersion, string sSessionID, int iCustomerID, int iQuoteID)
            {
                ...
                try
                {
                    ...
                    string spersonalpossessions = ostructureInstance.XIIValue("personalpossessionsPH").sDerivedValue;
                    ...
                    {
                        oXiResults.Add(BuildCResultObject(">2", "NoOfClaims", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    ...
                    if (oClaimI != null)
                    {
                        ...
                        {
                            oXiResults.Add(BuildCResultObject(">= 1500", "Claim Cost", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                        }
                    ...
                    {
                        oXiResults.Add(BuildCResultObject("0.0", "If felt roof has not been replaced in last 10 years", xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString()));
                    }
