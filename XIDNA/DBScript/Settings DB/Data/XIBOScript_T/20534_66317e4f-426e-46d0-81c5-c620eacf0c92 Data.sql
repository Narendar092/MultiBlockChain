INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20534',
 N'296',
 N'0',
 NULL,
 N'Charity Product1',
...
public class PolicyCalculation {
  ...
  public CResult Calculation(string sGUID, string iInstanceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sProductCode, int iQuoteID, string sSessionID = null) {
    ...
    try {
      ...
      if (sSessionID == null) {
        ...
        oQSI = oLIst.Structure("Quotes XML").XILoad(); /*oLIst.Structure("charity qs").XILoad();    */
      ...
      if (oBOIList.Count > 0) {
        ...
        DataTable dtbulk = xibulk.MakeBulkSqlTable(oBOIList); /* xibulk.SaveBulk(dtbulk, oBOIList[0].BOD.iDataSourceoBOIList[0].BOD.iDataSourceXIGUID.ToString(), oBOIList[0].BOD.TableName);*/
 ...
 N'',
 N'config configu',
 N'2021-12-06 10:17:27.000',
 N'2021-12-06 10:41:22.000',
 NULL,
 NULL,
 NULL,
