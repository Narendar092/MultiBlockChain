INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult CaravanCalculation(List<CNV> lParam)
        ...
        public class TouringCaravan
        {
            ...
            public static double rMinPremium = 0;
            ...
            public CResult GetFinalPremium(List<CNV> oParams)
            {
                ...
                try
                {
                    ...
                    dPolicyGrossPremium += (dPolicyGrossPremium * 0.01) * rAdditionalLoad;
                    if (dPolicyGrossPremium < rMinPremium)
                    {
                        oGeneralRefers.Add(BuildCResultObject(rMinPremium.ToString(), "Minimum Premium", xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString()));
                        dPolicyGrossPremium = rMinPremium;
                    }
