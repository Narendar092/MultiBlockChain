INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "Payment Bazar script running";
            ...
            try
            {
                ...
                string ProductID = lParam.Where(m => m.sName == "ProductID").FirstOrDefault().sValue;
                ...
                oIB.SaveErrortoDB(oResult);
                oResult = Pcal.Calculation(oQsInstance, iUserID, iCustomerID, sDataBase, sProductName, ProductID, sVersion);
                oNV.sValue = "00";
            }
            catch (Exception ex)
            {
        ...
        public abstract class PolicyBaseCalc
        {
            ...
            public abstract double GetPremium(string TypeOfCover, double Amount);
            ...
            public CResult GetLeftHandDriveLoadFactor(string IsLeftHandDrive)
            {
                ...
                try
                {
                    ...
                    if (IsLeftHandDrive.ToLower() == "yes")
                    {
                        oNV1.sValue = "+10";
                    }
                    oresult.oCollectionResult.Add(oNV);
        ...
        {
            public CResult Calculation(XIIQS QSInstance, int iUserID, int iCustomerID, string sDataBase, string sProductName,string ProductID, string sVersion)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oResult = new CResult();
                try
                {
                    ...
                    var oQSI = oIXI.BOI("QS Instance", QSInstance.ID.ToString()).Structure("NotationStructure").XILoad();
                    ...
                    string sOccupation = ostructureInstance.XIIValue("sOccupation").sValue;
                    ...
                    string sCaravanNoClaimsDiscount = ostructureInstance.XIIValue("sCaravanNoClaimsDiscountUpdated").sValue;
                    ...
                    var oOnRoadLoadLoadFactor = PolicyCal.GetOnRoadLoadLoadFactor(sPostCode, sDataBase, sProductName, sVersion);
                    ...
                    if (sCaravanNoClaimsDiscount != null)
                    {
                        ...
                        var oProtectedNoClaimDiscountLoadFactor = PolicyCal.GetProtectedNoClaimsDiscount(iCaravanNoClaimsDiscount);
                    ...
                    if (oXiResults.All(m => m.oCollectionResult.Where(x => x.sName == "sMessage").All(x => x.sValue == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())) && oExcessVal.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())
                    {
                        ...
                        if (IPTLoadFactor.oCollectionResult != null)
                        {
                            ...
                            result = PolicyCal.BuildCResultObject(IPT.ToString(), "IPT");
                            oXiResults.Add(result);
                    ...
                    oBII.Attributes["FKiQSInstanceID"] = new XIIAttribute { sName = "FKiQSInstanceID", sValue = QSInstance.ID.ToString(), bDirty = true };
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "Payment Bazar", bDirty = true };
                    ...
                    oBII.Attributes["UpdatedTime"] = new XIIAttribute { sName = "UpdatedTime", sValue = DateTime.Now.ToString(), bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "Payment Bazar Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
                    XIIBO oBO = new XIIBO();
                    ...
                    oBO.Attributes["CreatedTime"] = new XIIAttribute { sName = "CreatedTime", sValue = DateTime.Now.ToString("dd-M-yy"), bDirty = true };
        ...
        {
            public override double GetPremium(string TypeOfCover, double Amount)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                double NetAmount = Amount;
                oresult.sMessage = "TypeOfCover-" + TypeOfCover + "Amount_" + Amount;
                oIB.SaveErrortoDB(oresult);
                try
                {
                    //oresult.xiStatus = xiEnumSystem.xiFuncResult.xiSuccess;
                    ...
                    oresult.sMessage = "NetAmount_" + NetAmount;
                    oIB.SaveErrortoDB(oresult);
                    //oNVsList.Add(oNV);
                    //oNVsList.Add(oNV1);
 ...
 N'C# Code',
 N'0',
 N'2018-11-05 15:59:00.000',
 N'6',
 N'192.168.3.161',
 N'6',
 N'192.168.7.6',
 N'2018-12-12 15:11:06.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
