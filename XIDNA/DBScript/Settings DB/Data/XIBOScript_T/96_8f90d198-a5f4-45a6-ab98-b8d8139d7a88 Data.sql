INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            oResult.sMessage = "Business MTA script running";
            ...
            public CResult Calculation(int iInsatnceID, string dCoverStart, string rGrossPremium, string QuoteID)
            {
                ...
                try
                {
                    ...
                    var QuotePrice= oQuoteI.Attributes["rPrice"].sValue;
                     oResult.sMessage = "HSBC QuotePrice" + QuotePrice;
                     oIB.SaveErrortoDB(oResult);
                    if(double.TryParse(QuotePrice ,out total))
                    { }
                     oResult.sMessage = "HSBC Quote total" + total;
                     oIB.SaveErrortoDB(oResult);
                    if (total > 0)
                    {
                    ...
                    oResult.sMessage = "HSBC MTA Cost " + total;
                    oIB.SaveErrortoDB(oResult);
                    if (total >= -25 && total <=0)
                    {
                        total = 0.0;
                ...
                oBII.Attributes["rPrice"] = new XIIAttribute { sName = "rPrice", sValue = total.ToString(), bDirty = true };
                    ...
                    oBII = oBII.Save(oBII);
                    oResult.sMessage = "HSBC Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
 ...
 N'C# Code',
 N'0',
 N'2018-12-17 09:31:46.000',
 N'6',
 N'192.168.7.6',
 N'6',
 N'192.168.7.6',
 N'2018-12-17 09:33:25.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
 ...
 NULL,
 NULL,
 N'8f90d198-a5f4-45a6-ab98-b8d8139d7a88',
 N'0',
 N'0',
 N'0',
