INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20382',
 N'296',
 N'0',
 NULL,
 N'Legal help simple cal Copy',
 N'PolicyCalculation',
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            try
            {
                ...
                oBII.Attributes["rPrice"] = new XIIAttribute { sName = "rPrice", sValue = "156.45", bDirty = true };
                oBII.Attributes["FKiQSInstanceID"] = new XIIAttribute { sName = "FKiQSInstanceID", sValue = iInsatnceID.ToString(), bDirty = true };
                oBII.Attributes["sName"] = new XIIAttribute { sName = "sName", sValue = "Legal Help", bDirty = true };
                oBII.Attributes["rFinalQuote"] = new XIIAttribute { sName = "rFinalQuote", sValue = "156.45", bDirty = true };
