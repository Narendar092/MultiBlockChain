INSERT INTO [XIBOScript_T] ([ID],
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        ...
        public abstract class PolicyBaseCalc
        {
            ...
            public CResult GetOwnershipDiscount(int YearOfOwnerShip)
            {
                ...
                try
                {
                    ...
                    else if (YearOfOwnerShip > 13 && YearOfOwnerShip <= 24)
                    {
                        oNV1.sValue = "-5";
                    }
                    else if (YearOfOwnerShip > 25 && YearOfOwnerShip <= 32)
                    {
                        oNV1.sValue = "-10";
                    }
                    else if (YearOfOwnerShip > 33 && YearOfOwnerShip <= 48)
                    {
                        oNV1.sValue = "-15";
                    }
                    else if (YearOfOwnerShip > 49 && YearOfOwnerShip <= 60)
                    {
                        oNV1.sValue = "-20";
                    }
    ...
    public CResult Modifications(string sModification)
     ...
     string[] DeclineArray = new string[] { "Exhaust", "Standard Engines Replacement", "Suspension Upgraded", "LPG Conversion", "other", }
                    if (sModification == "on")
      ...
      var dPassed = item.AttributeI("dDateTestPassed").sResolvedValue;
                        ...
                        if (ores.xiStatus == 0 && ores.oResult != null)
                        {
                            ...
                            if (dpassedyr < 3 && (sDrivingQualifiication == "Full UK"))
                            {
                        ...
                        if (sDrivingQualifiication.TrimEnd() == "Full UK")
                        {
                       ...
                       //{/
                            //int dUkResyr = (int)oukresidencyres.oResult;
     ...
     //string svehicleModifications = ostructureInstance.XIIValue("sVehicleModificationsDescription").sResolvedValue;
      ...
      // Fields For General Declines
                    ...
                    oIB.SaveErrortoDB(oResult);
                    oResult.sMessage = "iYearOfOwnership:" + iYearOfOwnership;
                    oIB.SaveErrortoDB(oResult);
                    oResult.sMessage = "iYearOfOwnershipInMonths:" + iYearOfOwnershipInMonths;
                    //var oOwnerShipLoad = PolicyCal.GetOwnershipDiscount(iYearOfOwnership);
     ...
     //Modificatons
                    ...
                    oResult.sMessage = "sVechileModification_sVal_"+svehicleModifications;
                    oIB.SaveErrortoDB(oResult);
                    ...
                    oResult.sMessage = "KGM FEB Quote inserted Sucessfully with the amount of " + total;
                    oIB.SaveErrortoDB(oResult);
                    XIIBO oBO = new XIIBO();
