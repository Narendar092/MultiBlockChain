INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20',
 N'296',
 N'0',
 NULL,
 N'MoneySuperMarket',
 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            try
            {
                ...
                //oIB.SaveErrortoDB(oResult);
                oResult = Pcal.Calculation(iInsatnceID, iUserID, iCustomerID, sDataBase, sProductName, sVersion);
                oNV.sValue = "00";
            }
            catch (Exception ex)
            {
        ...
        {
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oResult = new CResult();
                try
 ...
 N'C# Code',
 N'0',
 N'2018-09-12 10:54:49.000',
 N'6',
 N'fe80::ad6c:bdf0:2de6:369d%3',
 N'6',
 N'192.168.7.6',
 N'2018-12-15 12:34:06.000',
 N'15',
 N'PolicyMainCal',
 NULL,
 NULL,
