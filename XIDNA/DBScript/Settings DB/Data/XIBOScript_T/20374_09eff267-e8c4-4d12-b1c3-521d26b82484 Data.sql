INSERT INTO [XIBOScript_T] ([ID],
 ...
 [FKiTagSpaceIDXIGUID],
 [FKiVersionIDXIGUID]) Values(N'20374',
 N'296',
 N'0',
 NULL,
 N'GEOSC Copy',
        ...
        public class PolicyBaseCalc
        {
            ...
            public CResult GetHireLoadFactor(string sHire)
            {
                ...
                try
                {
                    ...
                    CNV oNV2 = new CNV();
                    oNV2.sName = "LoadFactorName";
                    oNV2.sValue = "Wilful and Deliberate Acts?";
                    CNV oNV3 = new CNV();
                    oNV3.sName = "Type";
                    oNV3.sValue = "Value";
            ...
            public CResult GetAnchoredLoadFactor(string sAnchore)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                try
                {
                    ...
                    CNV oNV2 = new CNV();
                    oNV2.sName = "LoadFactorName";
                    oNV2.sValue = "Anchored?";
                    CNV oNV3 = new CNV();
                    oNV3.sName = "Type";
                    oNV3.sValue = "Percent";
                    if (!string.IsNullOrEmpty(sAnchore) && sAnchore.ToLower() == "no")
                    {
                        oNV1.sValue = "+25";
                    }
                    oresult.oCollectionResult.Add(oNV);
        ...
        public class PolicyCalculation
        {
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sProductCode, string sSessionID, string sUID, int iQuoteID)
            {
                ...
                try
                {
                    ...
                    string sSumInsuredNew = ostructureInstance.XIIValue("insureyourScNew").sValue;
                    ...
                    string sHire = ostructureInstance.XIIValue("leisureholidaymakersSC").sDerivedValue;
                    string sMake = ostructureInstance.XIIValue("sCaravanMakeUpdated").sDerivedValue;
                    ...
                    string sMotorOffence = ostructureInstance.XIIValue("sMotorOffenceSC").sDerivedValue;
                    string sBankruptcy = ostructureInstance.XIIValue("bankruptcySC").sDerivedValue;
                    ...
                    string sInsuredPolicyDetails = ostructureInstance.XIIValue("PreviousMotorOrCaravanInsurancePolicyDetailsSC").sDerivedValue;
                    ...
                    string sRepair = ostructureInstance.XIIValue("RepairSC").sDerivedValue;
                    string sAnchored = ostructureInstance.XIIValue("firmsolidbaseSC").sDerivedValue;
                    double rSumInsuerd = 0;
                    double rTotalSumInsured = 0;
                    if (!string.IsNullOrEmpty(sTypeOfCovered) && sTypeOfCovered.ToLower() == "new for old")
                    {
                        double.TryParse(sSumInsuredNew, out rSumInsuerd);
                    }
                    else
                    {
                    ...
                    //Anchored Load
                    var oAnchoredLoad = PolicyCal.GetAnchoredLoadFactor(sAnchored);
                    if (oAnchoredLoad.xiStatus == 0 && oAnchoredLoad.oCollectionResult != null)
                    {
                        oXiResults.Add(oAnchoredLoad);
                    }
                    ...
                    if (!string.IsNullOrEmpty(sRepair) && sRepair.ToLower() == "no")
                    {
                        oGeneralRefers.Add(PolicyCal.BuildCResultObject("0.0", "Good state of repair", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                    }
                    //General Declines
                    ...
                    if (oPostCodeI != null && oPostCodeI.Attributes.ContainsKey("group"))
                    {
                        ...
                        {
                            bIsFlood = true;
                            if (oArea.ToLower() == "decline")
                            {
                                oGeneralDeclines.Add(PolicyCal.BuildCResultObject("0.0", "PostCode", xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString()));
                            }
                            else if (oArea.ToLower() == "refer")
                            {
                                oGeneralDeclines.Add(PolicyCal.BuildCResultObject("0.0", "PostCode", xiEnumSystem.xiEnumPolicyLookupResponses.Refer.ToString()));
                            }
                        }
                    }
                    ...
                    oBII.Attributes["sInsurer"] = new XIIAttribute { sName = "sInsurer", sValue = "GEO", bDirty = true };
                    ...
                    oBII.Attributes["bIsFlood"] = new XIIAttribute { sName = "bIsFlood", sValue = bIsFlood.ToString(), bDirty = true };
                    oBII.Attributes["bIsApplyFlood"] = new XIIAttribute { sName = "bIsApplyFlood", sValue = true.ToString(), bDirty = true };
