 ...
 N'        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            try
            {
                ...
                oResult = Pcal.Calculation(iInsatnceID, iUserID, iCustomerID, sDataBase, sProductName, sVersion, sProductCode, sSessionID, sUID);
                oNV.sValue = "00";
            }
            catch (Exception ex)
            {
        ...
        public class PolicyBaseCalc
        {
            ...
            public CResult GetArea(string PostCode)
            {
            ...
            public CResult GetOwnershipDiscount(int YearOfOwnerShip)
            {
                ...
                try
                {
                    ...
                    oNV3.sName = "Type";
                    oNV3.sValue = "Percent";
                    if (YearOfOwnerShip > 0 && YearOfOwnerShip <= 11)
                    {
                        oNV1.sValue = "+10";
                    }
                ...
                try
                {
                    ...
                    foreach (var Claim in ClaimI)
                    {
                        ...
                        if (ClaimYear < 3)
                        {
                            ...
                            if (sClaimName == "vandalism" || sClaimName == "malicious damage (theft)" || sClaimName == "theft")
                            {
                                dPoints = 20;
                            }
            ...
            public CResult GetConvictionsDemeritPoints(int NoOfConvictions, List<XIIBO> ConvictionI, string PolicyStartDate)
            {
                CResult oCResult = new CResult();
                ...
                try
                {
                    ...
                    foreach (var Conviction in ConvictionI)
                    {
                        ...
                        else if (BanDays > 28 && BanDays < 180 && convictionYear < 3)
                        {
                            sDemeritpoints = "20";
                        }
                        else
            ...
            public CResult GetOccupationsLoadFactor(string sOccupation)
            {
                ...
                try
                {
                    ...
                    string[] DeclineArray = new string[] { "Actor or Actress", "Amusement Caterers", "Gaming Board Inspector", "Gaming Club Manager", "Gaming Club Proprietor", "Gaming Club Staff - Licensed Premises", "Gaming Club Staff - Unlicensed Premises", "Gaming/Casino", "Demolition Contractor", "Demolition Worker", "Enquiry Agent", "Childrens Entertainer", " Entertainer", "Promoter - Entertainments", "Street Entertainer", "Fairground workers", "Driver - Hot Food Delivery", "Fast Food Delivery Driver", "Music Wholesaler", "Musical ArrangerMusician", "Musician - Amateur", "Musician - Classical", "Musician - Dance Band", "Musician - Pop Group", "Dealer - General", "Scrap Dealer", "Market Trader", "Street Trader", "Oil Rig Crew", "Gas Fitter", "Gas Mechanic", "Gas Technician", "Personalities", "Professional Sportsperson", "Semi-Professional Sportsperson", "Unemployed", "Disc Jockey", "Mobile Disc Jockey", "Golf Club Professional", "Night Club Staff", "Student", "Journalist", "Journalist - Freelance", "Journalistic Agent", "Diplomat", "Diplomatic Staff - British", "Diplomatic Staff - Foreign", "Diplomatic Staff - Republic Of Ireland", "Embassy Staff", "Embassy Staff - British", "Embassy Staff - Foreign", "Embassy Staff - Republic Of Ireland", "Premises Security Installers", "Security Consultant", "Security Controller", "Security Guard", "Security Office", "House Parent", "Assistant Teacher", "Dance Teacher", "Deputy Head Teacher", "Headteacher", "Music Teacher", "Piano Teacher", "Student Teacher", "Student Teacher - Living At Home", "Student Teacher - Living Away", "Supply Teacher", "Teacher", "Teachers Assistant", "Yoga Teacher", "Courier", "Courier - Driver", "Courier - Motorcycle", "Courier - Parcel Delivery", "Delivery Courier", "Travel Courier", "Mature Student", "Mature Student - Living At Home", "Mature Student - Living Away", "Medical Student", "Medical Student - Living At Home", "Medical Student - Living Away", "Post Graduate Student Living at Home", "Post Graduate Student Living Away from Home", "School Student", "Student", "Student - Foreign", "Student - Living at Home", "Student - Living Away", "Student Counseller", "Student Nurse", "Student Nurse - Living At Home", "Student Nurse - Living Away", "Student Teacher", "Student Teacher - Living At Home", "Student Teacher - Living Away", "Undergraduate Student - Living At Home", "Undergraduate Student - Living Away from Home" };
            ...
            public CResult GetGaragingLoadFactor(string sWheredoyoustore, double rCaravanValue, string sPostCode)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                try
                {
                    ...
                    else if (sWheredoyoustore == "Kept on Public Road" && rCaravanValue < 25000)
                    {
                        oNV1.sValue = "+10";
                    }
                    ...
                    else if ((sWheredoyoustore == "Kept on Public Road" && rCaravanValue > 25000) || (sWheredoyoustore == "car park" && rCaravanValue > 7500))
                    {
                        oNV.sValue = xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString();
                    }
                    else if (sWheredoyoustore == "not available" || sWheredoyoustore == "kept on third party premises" || sWheredoyoustore == "unlocked building" || sWheredoyoustore == "unlocked compound" || sWheredoyoustore == "shed" || sWheredoyoustore == "wooden shed")
                    {
                        oNV.sValue = xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString();
                    }
                    oresult.oCollectionResult.Add(oNV);
            ...
            public CResult DemeritPoints(int idemeritPoins, string sLoadName)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oresult = new CResult();
                try
            ...
            public CResult Modifications(string sModification)
            {
                ...
                try
                {
                    ...
                    oNV3.sName = "Type";
                    oNV3.sValue = "Percent";
                    sModification = sModification.ToLower();
                    if (sModification == "on")
                    {
                        oNV.sValue = xiEnumSystem.xiEnumPolicyLookupResponses.Decline.ToString();
                    }
        ...
        {
            public CResult Calculation(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string sProductCode, string sSessionID, string sUID)
            {
                ...
                try
                {
                    ...
                    foreach (var item in oDriversI)
                    {
                        ...
                        oWParams.Add(oWP);
                        oSQLParams.Add(new SqlParameter { ParameterName = "@Name_6", Value = item.AttributeI("sName").sValue });
                        oWP = new XIWhereParams();
                        oWP.sField = "Name_1";
                        oWP.sOperator = "=";
                        oWP.sValue = item.AttributeI("sForeName").sValue;
                        oWParams.Add(oWP);
                        oSQLParams.Add(new SqlParameter { ParameterName = "@Name_1", Value = item.AttributeI("sForeName").sValue });
                        oWP = new XIWhereParams();
                        oWP.sField = "DOB";
                        oWP.sOperator = "=";
                        oWP.sValue = dDOB;
                        oWParams.Add(oWP);
                        oSQLParams.Add(new SqlParameter { ParameterName = "@DOB", Value = dDOB });
                        oWP = new XIWhereParams();
                        ...
                        {
                            result = PolicyCal.GetConvictionsDemeritPoints(NoOfConvinctions, ConvinctionsList, dtInsuranceCoverStartDate);
                            if (result.xiStatus == 0)
                            {
                                int ipoints = 0;
                                int.TryParse(result.oResult.ToString(), out ipoints);
                    ...
                    string sTypeOfCaravan = ostructureInstance.XIIValue("sTypeOfCaravanUpdated").sValue;
                    //BaseRate
                    ...
                    var oArea = PolicyCal.GetArea(sPostCode);
                    if (oArea.xiStatus == 0 && oArea.oCollectionResult.Count > 0)
                    {
                        oAreaList.Add(oArea);
                    }
                    var oParkingArea = PolicyCal.GetArea(sParkingPostCode);
                    ...
                    if (ClaimConvictionResultList.Count > 0)
                    {
                        ...
                        if (oClaimConvictionLoad.xiStatus == 0 && oClaimConvictionLoad.oCollectionResult.Count > 0)
                        {
                            oXiResults.Add(oClaimConvictionLoad);
                        }
                    }
                    ...
                    //Garaging
                    var oGaraging = PolicyCal.GetGaragingLoadFactor(sGaraging, rCaravanVal, sPostCode);
                    ...
                    if (!string.IsNullOrEmpty(sTypeOfCaravan) && sTypeOfCaravan.ToLower() == "other")
                    {
                    ...
                    if (oXiResults.All(m => m.oCollectionResult.Where(x => x.sName == "sMessage").All(x => x.sValue == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())) && oCompulsaryExcessLoad.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && oBaseLoadFactor.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && IPTLoadFactor.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && oMinimumPremium.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && oOccupationsLoad.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString() && oGeneralDeclines.Count <= 0)
                    {
                        ...
                        oBII.Attributes["rGrossPremium"] = new XIIAttribute { sName = "rGrossPremium", sValue = total.ToString(), bDirty = true };
