...
namespace XIDNA
{
    ...
    public class SessionManager
    {
        ...
        public static Guid ApplicationIDXIGUID
        {
            get
            {
                var APPIDGUID = Guid.Empty;
                if (HttpContext.Current.Session != null && HttpContext.Current.Session[SessionManagerConstants.ApplicationIDXIGUID] != null)
                {
                    Guid.TryParse(HttpContext.Current.Session[SessionManagerConstants.ApplicationIDXIGUID].ToString(), out APPIDGUID);
                    return APPIDGUID;
                }
                else
                {
            ...
            set
            {
                if (HttpContext.Current.Session != null)
                {
                    HttpContext.Current.Session[SessionManagerConstants.ApplicationIDXIGUID] = value;
                }
            }
        }
        public static bool bDebug
        {
            ...
            {
                bool Debug = false;
                if (HttpContext.Current.Session != null && HttpContext.Current.Session[SessionManagerConstants.bDebug] != null)
                {
                    bool.TryParse(HttpContext.Current.Session[SessionManagerConstants.bDebug].ToString(), out Debug);
                    return Debug;
                }
                else
                {
            ...
            set
            {
                if (HttpContext.Current.Session != null)
                {
                    HttpContext.Current.Session[SessionManagerConstants.bDebug] = value;
                }
            }
        }
        ...
        public static int iLogLevel
        {
            get
            {
                if (HttpContext.Current.Session != null && HttpContext.Current.Session[SessionManagerConstants.iLogLevel] != null)
                {
                    return Convert.ToInt32(HttpContext.Current.Session[SessionManagerConstants.iLogLevel]);
                }
                else
                {
                    return 30;
            ...
            set
            {
                if (HttpContext.Current.Session != null)
                {
                    HttpContext.Current.Session[SessionManagerConstants.iLogLevel] = value;
                }
            }
        }
        
        public static XIInfraUserPreference UserPreference
        {
            get
            {
                if (HttpContext.Current.Session != null && HttpContext.Current.Session[SessionManagerConstants.UserPreference] != null)
                {
                    return (XIInfraUserPreference)(HttpContext.Current.Session[SessionManagerConstants.UserPreference]);
                }
                else
                {
                    return new XIInfraUserPreference() ;
                }
            }
            ...
            set
            {
                if (HttpContext.Current.Session != null)
                {
                    HttpContext.Current.Session[SessionManagerConstants.UserPreference] = value;
                }
            }
        }
    }
