...
if (sDlgTitle.length > 0) {
    ...
    TaskBarID = "TaskBarBtn-" + oDialogD.sLabel.replace(/ /g, '') + "-" + oLayoutD.sGUID;
                                                    ...
                                                    $(function(){
                                                        $(document).find(".editor_body").on("click",'[data-right-toggle="right-toggle"]',function(){
                                                            debugger;
                                                            $(this).parent().attr('right-toggle', 'toggle');
                                                        }).trigger("[data-right-toggle='right-toggle']");
                                                    });
                                                    ...
                                                    $(document).find('[data-right-toggle="right-toggle"]').clickToggle(function () {
                                                        debugger
                                                        $(this).parent().attr("right-toggle", "toggle");
                                                    }, function () {
