...
if (sDlgTitle.length > 0) {
    ...
    TaskBarID = "TaskBarBtn-" + oDialogD.sLabel.replace(/ /g, '') + "-" + oLayoutD.sGUID;
                                                    ...
                                                    $("." + DialogDivID).dialog("widget").resizable({ handles: "n, e, s, w" });
                                                    $("." + DialogDivID).find("iframe").contents().find(".editor_body").on("click",'[data-item="list_item"]',function(){
                                                        debugger;
                                                    ...
                                                    $("." + DialogDivID).find("iframe").contents().find('[data-item="list_item"]').clickToggle(function () {
                                                        debugger
