...
namespace XIDNA.Controllers
{
    ...
    public class LeadController : Controller
    {
            ...
            try
            {
                ...
                if (sData != null)
                {
                    ...
                    else
                    {
                        ...
                        //SendErrorAlert(FilePath, FKiOrgID);
        ...
        //    int FKiOrgID = 0;
        //    List<VMDropDown> list = LeadRepository.GetTemplateList(iType, database, FKiOrgID);
        ...
        //public ActionResult SendErrorAlert(string FilePath, int FKiOrgID)
        //{
        //    try
        //    {
        //        int iType = 1;
        ...
        //            var sDetails = LeadRepository.ServerDetails(iType, FKiOrgID);
        ...
        //        var sData = LeadRepository.DisplayCompleteLeadDetails(FKiOrgID, DbName);
        //        if (sData != null)
        //        {
        //            return Json(sData, JsonRequestBehavior.AllowGet);
        //        }
        ...
        //        else
        //        {
        //            VMQueryPreview content = LeadRepository.GetTabContent(Popup, UserID, FKiOrgID, Database);
        //            if (content != null)
        //            {
        //                VMViewPopup popup = new VMViewPopup();
        //                popup.TabID = Popup.TabID;
        ...
        public ActionResult PostQuoteToLead(int LeadID, int QuoteID, int BOID, int Tab1ClickID, int ReportID)
        {
            ...
            try
            {
                ...
                //Inbox.Message = "New quote is posted. Please <button class='QteBtn' id='" + Popup.QuoteID + "-"+FKiOrgID+"'>see</button> the details";
