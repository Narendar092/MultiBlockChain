...
namespace XIDNA.Controllers
{
    public class WalletController : Controller
    {
        ...
        public ActionResult SendClientRequest(int LeadID, string Email, int OrgID, string OrgName, int ClassID)
        {
            try
            {
                //LeadRepository.SendRegisterMail(Email, "Register", FKiOrgID, SessionManager.CoreDatabase, ClassID);
        ...
        //        int FKiOrgID = 0;
        //        string database = SessionManager.CoreDatabase;
        //        Policy.ProductList = WalletRepository.ProductList(FKiOrgID, 0);
        //        Policy.Templates = WalletRepository.TemplatesList(FKiOrgID);
