...
namespace XIDNA.Models
{
    ...
    public class ResetPasswordViewModel
    {
        ...
        [RegularExpression(@"^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$", ErrorMessage = "Must Be 8 Characters long & Combination Of Digits, Upper And Lower Case Letters")]
        [Display(Name = "Password")]
        public string Password { get; set; }
    ...
    public class RegisterViewModel
    {
        ...
        [RegularExpression(@"^[0][1-9]\d{9}$|^[1-9]\d{10}$", ErrorMessage = "Ex: 07222 555555 OR (07222) 555555 OR +44 7222 555 555")]
        public string PhoneNumber { get; set; }   
