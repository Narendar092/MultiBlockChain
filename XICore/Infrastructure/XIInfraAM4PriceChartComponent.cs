...
namespace XICore
{
    public class XIInfraAM4PriceChartComponent
    {
        ...
        public CResult XILoad(List<CNV> oParams)
        {
            ...
            try
            {
                ...
                XIGraphData AmountsDashboard = new XIGraphData();
                ...
                if (OneClickID > 0 || (OneClickIDXIGUID != Guid.Empty && OneClickIDXIGUID != null))
                {
                    ...
                    AmountsDashboard.OneClickRes = OneClickRes;
                    AmountsDashboard.OnClickResultID = OneClickID;
                    AmountsDashboard.sLastUpdated = o1ClickC.sLastUpdate;
                    AmountsDashboard.RowXilinkID = o1ClickC.RowXiLinkID.ToString();
                }
                oCResult.oResult = AmountsDashboard;
