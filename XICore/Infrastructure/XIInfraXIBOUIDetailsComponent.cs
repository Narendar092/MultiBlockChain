            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!string.IsNullOrEmpty(sInstanceID))
                    {
                     ...
                     sBOID = oCache.Get_ParamVal(sSessionID, sGUID, null, "iBODID");
                }
                ...
                {
                    var BOD = (XIDBO)(oCache.GetObjectFromCache(XIConstant.CacheBO, "", sBOID));
                    oBOUI.FKiBOID = BOD.BOID;
                    oBOUI.FKiBOIDXIGUID = BOD.XIGUID;
                }
