...
namespace XICore
{
    ...
    public class XIInfraNotifications
    {
        ...
        public CResult SaveNotifications(List<CNV> oParams)
        {
            ...
            try
            {
                oTrace.sClass = "XIInfraNotifications";
                oTrace.sMethod = "SaveNotifications";
                oTrace.iStatus = (int)xiEnumSystem.xiFuncResult.xiInProcess;
                XIInfraCache oCache = new XIInfraCache();
                XIIBO oBOI = new XIIBO();
                XIDXI oXID = new XIDXI();
                XIDBO oBOD = (XIDBO)oCache.GetObjectFromCache(XIConstant.CacheBO_All, "Notifications", null);
                if (!string.IsNullOrEmpty(oParams.Where(m => m.sName == "sOrgID").Select(m => m.sValue).FirstOrDefault()))
                {
                ...
                if (!string.IsNullOrEmpty(oParams.Where(m => m.sName == "iUserID").Select(m => m.sValue).FirstOrDefault()))
                {
                    iUserID = Convert.ToInt32(oParams.Where(m => m.sName == "iUserID").Select(m => m.sValue).FirstOrDefault());
                }
                if (!string.IsNullOrEmpty(oParams.Where(m => m.sName == "sDocumentID").Select(m => m.sValue).FirstOrDefault()))
                {
                ...
                if (!string.IsNullOrEmpty(oParams.Where(m => m.sName == "iStatus").Select(m => m.sValue).FirstOrDefault()))
                {
                ...
                oBOI.SetAttribute("iCategory", "10");
                ...
                oCR = oBOI.Save(oBOI);//to save Notifications
        ...
        public CResult Create(string sUser, string sNotificationType, string sDoc, string sSubject = "", string sMessage = "", string sInstanceID = "", string sOrgID = "")
        {
            ...
            try
            {
                ...
                switch (sNotificationType)
                {
                    ...
                    case "CLIENTDOC":
                        ...
                        oParams.Add(Params);
                        Params = new CNV();
                        Params.sName = "iInstanceID";
                        Params.sValue = sInstanceID;
                        oParams.Add(Params);
                    ...
                    case "Make a Claim":
                        ...
                        nvParam.sValue = sOrgID;
                        oParams.Add(nvParam);
                        nvParam = new CNV();
                        nvParam.sName = "sSubject";
                        nvParam.sValue = sSubject;
                        oParams.Add(nvParam);
                        nvParam = new CNV();
                    ...
                    default:
                        List<CNV> oParamsCNV = new List<CNV>();
                        CNV oCNV = new CNV();
                        oCNV.sName = "sOrgID";
                        oCNV.sValue = sOrgID;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "sSubject";
                        oCNV.sValue = sSubject;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "sMessage";
                        oCNV.sValue = sMessage;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "sDocumentID";
                        oCNV.sValue = sDoc;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "sOrgName";
                        oCNV.sValue = sOrgName;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "sMailType";
                        oCNV.sValue = sNotificationType;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "iUserID";
                        oCNV.sValue = sUser;
                        ...
                        oCNV = new CNV();
                        oCNV.sName = "sIcon";
                        oCNV.sValue = "fa fa-edit";
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "iInstanceID";
                        oCNV.sValue = sInstanceID;
                        oParams.Add(oCNV);
                        oCNV = new CNV();
                        oCNV.sName = "iStatus";
                        oCNV.sValue = iStatus.ToString();
                        oParams.Add(oCNV);

                        oCR = SaveNotifications(oParams);
                        oTrace.oTrace.Add(oCR.oTrace);
                        if (oCR.bOK && oCR.oResult != null)
                        {
                            oTrace.iStatus = (int)xiEnumSystem.xiFuncResult.xiSuccess;
