...
namespace XICore
{
    public class CScriptController
    {
        ...
        //        {-|7,3}
        // }
        public CCodeLine oTopLine = new CCodeLine();
        ...
        public CResult API2_Serialise_From_String(string sSerialFunction, string sFlag = null)
        {
            CResult oMyResult = new CResult();
            string sOriginal;
            try
            {
                ...
                if (sSerialFunction.Contains("[param "))
                {
                ...
                //sSerialFunction = sSerialFunction.Replace("_", "}");
                // 2018.05.16
                oTopLine = new CCodeLine();
                oTopLine.DeSerialiseMe(sSerialFunction, sOriginal, sFlag);
            }
            catch (Exception ex)
            {
            }
