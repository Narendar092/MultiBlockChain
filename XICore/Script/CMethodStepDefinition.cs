...
namespace XICore
{
    public class CMethodStepDefinition
    {
        ...
        public enum xiAlgoActionType
        {
            ...
            xiCommunicationout = 1270,

            xiImportFile = 1280,

            xiCopyStructure = 1290,

            xiCallOM = 1300,

            xiFileImport = 1310,
            xiEmailAttach=1320,
            xiRunDynamicScript=1330,
            xiProcessCommunication=1340,
            xiWebhookOutbound=1350,
            xiGetFKToObject = 1360,
            xiChildPC=1370,
            xi1ClickRun=1380,
            xiMatchCommunication=1390,
            xiExcelImport = 1400,
            xiImportLead = 1410,
            xiVersionise = 1420,
            xiSaveFile = 1430
        ...
        public CMethodStepDefinition NMethod(string sNodeName, string sKey = "")
        {
            ...
            string sNewKey = "";
            CMethodStepDefinition oNewM = null;
            CMethodStepDefinition NMethod = null;
            try
            {
                if (sKey == "")
                {
                ...
                if (sConcatKey != "")
                {
                    try
                    {
                        if (oMethodSteps.Contains(sConcatKey.ToLower()))
                        {
                            NMethod = (CMethodStepDefinition)oMethodSteps[sConcatKey.ToLower()];
                        }
                        else
                        {
                            ...
                            try
                            {
                                NMethod = (CMethodStepDefinition)oMethodSteps[sNewKey];
                            }
                            catch (Exception ex2)
                            {
                                //NMethod = null;
        ...
        CMethodStepDefinition AddMethod(string sMethodName)
        {
            ...
            try
            {
                ...
                if (oMethodSteps.Contains(sKey) || sKey == "")
                {
        ...
        public string sActionType
        {
            ...
            set
            {
                ...
                switch (sMyActionType.ToLower())
                {
                    ...
                    case "setcache":
                    case "m.setcache":
                        iActionType = xiAlgoActionType.xiSetCache;
                        break;
                    case "getcache":
                    case "m.getcache":
                        iActionType = xiAlgoActionType.xiGetCache;
                        break;
                    case "createbo":
                    case "m.createbo":
                    case "boc":
                    ...
                    case "loadqs":
                    case "m.loadqs":
                        iActionType = xiAlgoActionType.xiQSLoad;
                        break;
                    case "m.function":
                    case "function":
                        iActionType = xiAlgoActionType.xiFunction;
                        break;
                    case "m.recursive":
                    case "recursive":
                        iActionType = xiAlgoActionType.xiRecursive;
                        break;
                    case "m.setlinevalue":
                    case "setlinevalue":
                        iActionType = xiAlgoActionType.xiSetLineValue;
                        break;
                    case "m.runscript":
                    case "runscript":
                        iActionType = xiAlgoActionType.xiRunScript;
                        break;
                    case "m.setarray":
                    case "setarray":
                        iActionType = xiAlgoActionType.xiSetArray;
                        break;
                    case "m.getarray":
                    case "getarray":
                        iActionType = xiAlgoActionType.xiGetArray;
                        break;
                    case "m.writelog":
                    case "writelog":
                        iActionType = xiAlgoActionType.xiWriteLog;
                        break;
                    case "m.1clickcount":
                    case "1clickcount":
                        iActionType = xiAlgoActionType.xi1ClickCount;
                        break;
                    case "m.templatemerge":
                    case "templatemerge":
                        iActionType = xiAlgoActionType.xiTemplateMerge;
                        break;
                    case "m.qsinsert":
                    case "qsinsert":
                        iActionType = xiAlgoActionType.xiQSInsert;
                        break;
                    case "m.distributebo":
                    case "distributebo":
                        iActionType = xiAlgoActionType.xiDistributeBO;
                        break;
                    case "m.communicate":
                    case "communicate":
                        iActionType = xiAlgoActionType.xiCommunicate;
                        break;
                    case "m.communicationout":
                    case "communicationout":
                        iActionType = xiAlgoActionType.xiCommunicationout;
                        break;
                    case "m.importfile":
                    case "importfile":
                        iActionType = xiAlgoActionType.xiImportFile;
                        break;
                    case "m.copystructure":
                    case "copystructure":
                        iActionType = xiAlgoActionType.xiCopyStructure;
                        break;
                    case "m.callom":
                    case "callom":
                        iActionType = xiAlgoActionType.xiCallOM;
                        break;
                    case "m.fileimport":
                    case "fileimport":
                        iActionType = xiAlgoActionType.xiFileImport;
                        break;
                    case "m.emailattach":
                    case "emailattach":
                        iActionType = xiAlgoActionType.xiEmailAttach;
                        break;
                    case "m.rundynamicscript":
                    case "rundynamicscript":
                        iActionType = xiAlgoActionType.xiRunDynamicScript;
                        break;

                    case "m.processcommunication":
                    case "processcommunication":
                        iActionType = xiAlgoActionType.xiProcessCommunication;
                        break;
                    case "m.webhookoutbound":
                    case "webhookoutbound":
                        iActionType = xiAlgoActionType.xiWebhookOutbound;
                        break;
                    case "m.getfktoobject":
                    case "getfktoobject":
                        iActionType = xiAlgoActionType.xiGetFKToObject;
                        break;
                    case "m.childpc":
                    case "childpc":
                        iActionType = xiAlgoActionType.xiChildPC;
                        break;
                    case "m.1clickrun":
                    case "1clickrun":
                        iActionType = xiAlgoActionType.xi1ClickRun;
                        break;
                    case "m.matchcommunication":
                    case "matchcommunication":
                        iActionType = xiAlgoActionType.xiMatchCommunication;
                        break;
                    case "m.excelimport":
                    case "excelimport":
                        iActionType = xiAlgoActionType.xiExcelImport;
                        break;
                    case "m.importlead":
                    case "importlead":
                        iActionType = xiAlgoActionType.xiImportLead;
                        break;
                    case "m.versionise":
                    case "versionise":
                        iActionType = xiAlgoActionType.xiVersionise;
                        break;
                    case "m.savefile":
                    case "savefile":
                        iActionType = xiAlgoActionType.xiSaveFile;
                        break;
                    default:
        ...
        public string ImprintSelf()
        {
            ...
            sImprint = sImprint + sStepName + " - Return=\'" + sReturnType + "\' - Error = \'"
                        + sErrorType + "\' - Action=\'" + sActionType + "\' - Execute=\'" + sExecute + "\'" + "\r\n";
            return sImprint;
        }
        ...
        public CResult Validate()
        {
            ...
            try
            {
                ...
                if (bType)
                {
                    sValidationError = sValidationError + "Action Type is " + iActionType.ToString()
                        + " but the return type is " + iReturnType.ToString() + "\r\n";
                }
                ...
                if (bParams)
                {
                    sValidationError = sValidationError + "Action Type is " + iActionType.ToString() + " but the parameter count is "
                                + oParamSet.iChildCount + " and should be " + iParamCount + "\r\n";
                }
                ...
                foreach (var oXIParam in oParamSet.NNodeItems.Values)
                {
                    ...
                    {
                        sValidationError = sValidationError + "Parameter " + oXIParam.ToString() + " expected but does not exist in algorithm inbound parameters \r\n";
                    }
                }
                ...
                if (sValidationError != "")
                {
                    ...
                    oCResult.sMessage = "Method: " + sStepName + " - Validation Errors: " + "\r\n" + sValidationError;
                }
                ...
                foreach (CMethodStepDefinition oCMethod in oMethodSteps.Values)
                {
                    ...
                    {
                        oCResult.xiStatus = xiEnumSystem.xiFuncResult.xiError;
                        oCResult.sMessage = oCResult.sMessage + oCR.sMessage + "\r\n";
                    }
                }
            }
            catch (Exception ex)
